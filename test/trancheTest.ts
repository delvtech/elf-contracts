...
describe("Tranche", () => {
  ...
  describe("deposit", () => {
    ...
    it("should not allow new deposits after the timeout", async () => {
      ...
      await expect(
        fixture.tranche.connect(user1).deposit(initialBalance, await user1.getAddress())
    ...
    it("should correctly handle deposits with no accrued interest", async () => {
      ...
      await fixture.tranche.connect(user1).deposit(initialBalance, await user1.getAddress());
      await fixture.tranche.connect(user2).deposit(initialBalance, await user2.getAddress());
